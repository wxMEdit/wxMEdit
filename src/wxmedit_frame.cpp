...
wxString g_MadEdit_Version(wxT("wxMEdit v2.9.2"));
...
//#endif
    ...
    {
        wxPreviewFrame *frame = new wxPreviewFrame(preview, this, _T("wxMEdit Print Preview"),
            wxPoint(0, 0),
#ifdef __WXMSW__
            wxSize(600, 720)
#else
...
void MadEditFrame::OnToolsOptions(wxCommandEvent& event)
{
    ...
    if(g_OptionsDialog->ShowModal()==wxID_OK)
    {
        ...
        {
            wxRegKey *pRegKey = new wxRegKey(wxT("HKEY_CLASSES_ROOT\\*\\shell\\wxMEdit"));
            pRegKey->DeleteSelf();
            delete pRegKey;
        }
#endif
