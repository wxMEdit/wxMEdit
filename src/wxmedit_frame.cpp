...
wxT("Copyright (C) 2013-2023  JiaYanwei <wxmedit@gmail.com>\n")
...
const static CreditsList s_wxMEdit_Credits = boost::assign::pair_list_of
        ...
        (s_("fengjl026"),                   _("Patch submitter for wxMEdit/MadEdit"))
...
CommandData CommandTable[]=
{
    ...
    { 0,                1, menuInsertEnumeration,        wxT("menuInsertEnumeration"),        _("Insert &Ordered Sequence..."),             wxT("Shift-Alt-N"),  wxITEM_NORMAL,    olist_xpm_idx,     0,                     _("Insert ordered sequence with certain format in specified numbering system")},
    ...
    { ecInvertCase ,    2, menuInvertCase ,              wxT("menuInvertCase") ,              _("Inver&t Case"),                            wxT("Shift-Alt-U"),  wxITEM_NORMAL,    -1,                0,                     _("Invert the case of the selection")},
    { 0,                2, 0,                            0,                                   0,                                            0,                   wxITEM_SEPARATOR, -1,                0,                     0},
    ...
    { 0,            1, menuFixedWidthMode,    wxT("menuFixedWidthMode"),    _("&Fixed Width Mode"),    wxT("Shift-Alt-F"),  wxITEM_CHECK,     -1,                 0,                         _("Set/Unset the font with Fixed Width")},
    ...
    { 0,              1, menuShowEndOfLine,     wxT("menuShowEndOfLine"),     _("Show End Of Line"),     wxT("Shift-Alt-L"),  wxITEM_CHECK,     -1,                 0,                         _("Show the sign of EndOfLine")},
    { 0,              1, menuShowTabChar,       wxT("menuShowTabChar"),       _("Show Tab Char"),        wxT("Shift-Alt-T"),  wxITEM_CHECK,     -1,                 0,                         _("Show the sign of Tab char")},
    { 0,              1, menuShowSpaceChar,     wxT("menuShowSpaceChar"),     _("Show Space Char"),      wxT("Shift-Alt-S"),  wxITEM_CHECK,     -1,                 0,                         _("Show the sign of Space char")},
