...
const long WXMOptionsDialog::ID_WXCHECKBOXCHECKPRERELEASE = wxNewId();
...
const long WXMOptionsDialog::ID_PANEL5 = wxNewId();
...
WXMOptionsDialog::WXMOptionsDialog(wxWindow* parent,wxWindowID id)
{
	...
	BoxSizer3->Add(BoxSizer4, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
	...
	BoxSizer7->Add(WxCheckBoxSingleInstance, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
	...
	BoxSizer7->Add(WxCheckBoxRecordCaretMovements, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
	...
	BoxSizer37->Add(WxCheckBoxDoNotSaveSettings, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
	BoxSizer36->Add(BoxSizer37, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer36->Add(BoxSizer17, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
	...
	BoxSizer38->Add(WxEditMaxSizeToLoad, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
	...
	BoxSizer38->Add(StaticText1, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer36->Add(BoxSizer38, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 2);
	...
	BoxSizer5->Add(WxStaticTextDateTime, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer5->Add(3,0,0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
	...
	BoxSizer5->Add(WxButtonDateTime, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
