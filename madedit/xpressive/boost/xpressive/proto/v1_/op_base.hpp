...
#define BOOST_PROTO_V1_DEFINE_MEMBER_OPS()                                                         \
    ...
    BOOST_PP_REPEAT_FROM_TO(1, BOOST_PP_INC(BOOST_PROTO_MAX_ARITY), BOOST_PROTO_V1_FUN_OP, _)
...
#define BOOST_PROTO_V1_FUN_OP(z, n, _)                                                             \
    ...
    #define BOOST_PROTO_V1_NARY_OP_CTOR(z, n, _)                                                   \
        ...
        BOOST_PP_REPEAT(BOOST_PP_INC(BOOST_PROTO_MAX_ARITY), BOOST_PROTO_V1_NARY_OP_CTOR, _)
