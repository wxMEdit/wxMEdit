...
CommandData CommandTable[]=
{
    ...
    { 0,              1, menuShowSpaceChar,     wxT("menuShowSpaceChar"),     _("Show Space Char"),      wxT(""),             wxITEM_CHECK,     -1,                 0,                         _("Show the sign of Space char")},
    ...
    { 0,               2, menuInsertDOS,          wxT("menuInsertDOS"),          _("Insert CRLF/0D0A (&DOS)"),                       wxT(""),       wxITEM_NORMAL,    -1, 0,                                _("Insert CR&LF chars when press Enter key")},
    ...
    { 0,               2, menuSimp2TradChinese,   wxT("menuSimp2TradChinese"),   _("File: Simplified => &Traditional Chinese"),      0,             wxITEM_NORMAL,    -1, 0,                                _("Convert simplified Chinese chars to traditional Chinese chars in the file")},
    { 0,               2, menuTrad2SimpChinese,   wxT("menuTrad2SimpChinese"),   _("File: Traditional => &Simplified Chinese"),      0,             wxITEM_NORMAL,    -1, 0,                                _("Convert traditional Chinese chars to simplified Chinese chars in the file")},
    { 0,               2, 0,                      0,                             0,                                                  0,             wxITEM_SEPARATOR, -1, 0,                                0},
    { 0,               2, menuSimp2TradClipboard, wxT("menuSimp2TradClipboard"), _("Clipboard: Simplified => T&raditional Chinese"), 0,             wxITEM_NORMAL,    -1, 0,                                _("Convert simplified Chinese chars to traditional Chinese chars in the clipboard")},
    { 0,               2, menuTrad2SimpClipboard, wxT("menuTrad2SimpClipboard"), _("Clipboard: Traditional => S&implified Chinese"), 0,             wxITEM_NORMAL,    -1, 0,                                _("Convert traditional Chinese chars to simplified Chinese chars in the clipboard")},
